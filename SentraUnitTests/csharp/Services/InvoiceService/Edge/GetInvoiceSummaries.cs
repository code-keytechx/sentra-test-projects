...
public class InvoiceServiceTests
{
    ...
    {
        // Arrange
        var listArgs = new InvoiceListArgs { SearchTerm = "test", PageNumber = 1, PageSize = 10 };
        var invoices = new List<Invoice>
        {
            new Invoice { Id = 1, CustomerName = "Test Customer", InvoiceDate = DateTime.Now, TotalAmount = 100, Status = "Paid" },
            new Invoice { Id = 2, CustomerName = "Another Customer", InvoiceDate = DateTime.Now, TotalAmount = 200, Status = "Pending" }
        };
